                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" action="{{ route('penjualan.update',['id'=> $penjualan->id_penjualan]) }}" method="POST">
                                        @csrf
                                        {{method_field('PUT')}}
                                            ...
                                            <div class="col-lg-6">
                                                <select  id="namabarang" name="barang" class="form-control">
                                                   <?php foreach ($barangs as $br): ?>
                                                        <option <?php if ($penjualan->id_barang == $br->id_barang): ?>
                                                            selected
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="number" min="1" value="{{ $penjualan->jumlah }}" class="form-control" id="jumlah" name="jumlah" placeholder="jumlah">
                                                @error('jumlah')
                                                {{ $message }}
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <select name="status" id="" class="form-control">
                                                    ...
                                                    <option value="{{ $penjualan->status }}">{{ $penjualan->status }}</option>
