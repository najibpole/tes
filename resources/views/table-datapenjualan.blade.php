                                    ...
                                    <table class="table table-striped table-bordered zero-configuration">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                    ...
                                                    <td>{{$row->status}}</td>                                                
                                                    <td>
                                                            <a class="btn btn-primary" href="{{route('penjualan.edit', ['id'=>$row->id_penjualan])}}">edit</a> &nbsp;
                                                            <a type="button" class="btn btn-danger" href="#" onclick="hapus(event, '{{ route('penjualan.destroy', ['penjualan' => $row->id_penjualan]) }}')">hapus</a>
                                                    </td>                                                
                                                </tr>
